...
exports.fromfile = exports.history = exports.stories = exports.getStories = exports.getUserMeta = exports.following = exports.followers = exports.likers = exports.comments = exports.location = exports.hashtag = exports.user = void 0;
...
exports.stories = async (input, options) => {
    if (options && typeof options !== 'object') {
        throw new TypeError('Object is expected');
    }
    const constructor = Object.assign(Object.assign(Object.assign({}, INIT_OPTIONS), options), { scrapeType: 'post_meta', input });
